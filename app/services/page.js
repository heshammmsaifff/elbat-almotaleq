  ...
  const allServices = [
    {
      ...
      subtitle: "نصنع الفخامة في كل زاوية",
      description:
        "نحن في البيت المتألق لا نصمم غرفاً فحسب، بل نصنع تجربة حياة. تشمل خدماتنا التصميم الداخلي السكني والتجاري، توزيع الإضاءة الذكي، واختيار الخامات التي تجمع بين الجمال والعملية. سواء كنت تفضل النمط المودرن أو الكلاسيك، فريقنا يحول خيالك إلى واقع.",
      features: [
        "تخطيط المساحات",
        "تصميم الأثاث المخصص",
        "تنسيق الألوان والإضاءة",
      ],
    ...
    },
    {
      ...
      subtitle: "واجهات تعكس هويتكم",
      description:
        "واجهة منزلك هي الانطباع الأول. نقدم خدمات تصميم وتنفيذ الواجهات باستخدام أرقى المواد (بروفايل، حجر، بديل خشب، تيوبات حديد). نركز على دمج العناصر المعمارية الحديثة مع مراعاة الظروف المناخية لضمان استدامة الجمال.",
      features: [
        "تصميم واجهات مودرن",
    ...
    },
    {
      id: "landscaping",
      title: "تنسيق الحدائق",
      subtitle: "واحتكم الخاصة في قلب المنزل",
      description:
        "نحول الفناء الخارجي إلى متنفس طبيعي يبعث على الراحة. خدماتنا تشمل تصميم الحدائق المنزلية، تركيب العشب الصناعي والطبيعي، إنشاء الشلالات والنوافير، وتصميم الجلسات الخارجية (البرجولات) بأنظمة ري حديثة وموفرة.",
      features: [
    ...
    },
    {
      id: "closets",
      title: "خزائن الملابس",
      subtitle: "حلول تخزين ذكية وأنيقة",
      description:
        "نصمم خزائن الملابس (Dressing Rooms) التي تجمع بين استغلال المساحات الصغير والمنظر الجمالي الفخم. نستخدم أجود أنواع الأخشاب والإكسسوارات العالمية لضمان سهولة الاستخدام وطول العمر الافتراضي لخزائنكم.",
      features: [
        "خزائن مبتكرة بذكاء",
    ...
    <main className="min-h-screen bg-slate-50 pt-32 pb-20" dir="rtl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-24">
          ...
          >
            <CheckCircle size={16} />
            <span>حلول هندسية وفنية متكاملة</span>
          </motion.div>
          <motion.h1
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            نقدم حزمة واسعة من الخدمات التي تغطي كافة جوانب منزلك، من المخططات
            الأولية وحتى تسليم المفتاح، مع التركيز التام على الجودة والابتكار.
          </motion.p>
        </div>
        ...
        >
          <div className="relative z-10">
            ...
            <p className="text-slate-400 text-xl mb-10 max-w-2xl mx-auto">
              لا تتردد في مشاركتنا أي صورة أو فكرة رأيتها، فريقنا متخصص في تحويل
              الصور المقتبسة إلى واقع حي في منزلك.
            </p>
            <Link
              href="/contact"
